...
class RepositoryToGet:
    ...
    def get_product_prices(self, asin_id: str) -> List[Tuple[str, float, str]]:
    ...
    # asin_idの直近3件の判定を取得
    def get_product_decisions(self, product_id: int) -> List[Dict[int, bool]]:
    ...
    def get_expected_import_fees(self, asin_id: int) -> Dict[str, Any]:
...
class RepositoryToUpdate:
    ...
    def update_product_price(self, id: int, price: Dict[str, Any]) -> None:
    ...
    def update_expected_import_fees(self, id: int, price: float) -> None:
    ...
    def update_expected_roi(self, asin_id: int, roi: float) -> None:
    ...
    def update_product_decision(self, record: Dict[str, Any], decision: bool) -> None:
...
class EvaluateAsinAndSellers:
    ...
    def evaluate_product_price(self, prices: List[Tuple[str, float, str]]) -> Dict[str, Any]:
...
class Calculator:
    ...
    def process_product_price(self, record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        product_prices = min_price_product
    ...
    def process_expected_import_fees(self, record_product_detail: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logging.info(f"Expected import fees for product id {record_product_detail['id']}: {expected_import_fees}")  
        return record_product_detail
    
    def process_expected_roi(self, record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        roi = (sales_price - product_price - commission - expected_import_fees) / product_price
