...
class KeepaClient(IKeepaClient):
    ...
    def search_asin_by_seller(self, seller: str) -> List[Optional[str]]:
        try:
...
## for seller
    def query_seller_info(self, asin: str) -> List[Optional[SellerInfoData]]:
    ...
    def search_three_month_sales(self, asin: str) -> Optional[int]:
