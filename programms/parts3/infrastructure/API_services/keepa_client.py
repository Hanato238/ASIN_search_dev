...
import programms.parts2.modules.repository_for_tables as repo
...
class AsinSearcher:
    ...
    def process_seller(self) -> None:
        ...
        sellers = self.repo.sellers.get_sellers_to_process()
        for seller in sellers:
            ...
            for asin in asins:
                self.repository.repo.products_master.create_new_product(asin)
                product_id = self.repository.get_product_id(asin)
                if asin_id:
